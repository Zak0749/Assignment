...
<main>
    <form class="tabbed-main" onsubmit="submitCreateDeck(this); return false" oninput="contentChanged()">
        <section id="info-tab" class="split-main selected-tab">
            <section>
                ...
                <div class="form-field">
                    ...
                    <textarea name="description" type="text" maxlength="512" required oninput="autoHeight(this)"></textarea>
                </div>
